...
def main():
    ...
    try:
        ...
        result = client.send(message=api.SMSMessage('hello from notificore.com'), recipients=recipient)
        ...
        results = client.send(message=api.SMSMessage('hello from notificore.com'), recipients=[recipient0, recipient1])
