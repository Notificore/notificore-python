...
def main():
    ...
    try:
        ...
        client.add_message(api.ViberMessage(to=[recipient], text='message text from Notificore REST API'))
        ...
        client.add_message(
            api.ViberMessage(
                ...
                text='another message text from Notificore REST API'))
        results = client.send()
        ...
        result = client.send(
            api.ViberMessage(
                ...
                alt_route=dict(originator='Notificore', text='sms message text from viber alt_route'),
                text='viber message text from Notificore REST API'))
