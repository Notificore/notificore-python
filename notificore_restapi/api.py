...
class Recipient(dict):
    def __init__(self, msisdn: Union[int, str] = None, reference: str = None, **kwargs):
        ...
        if not msisdn or not len(str(msisdn)) <= 15:
            # raise error without real API request, for error codes see https://app.notificore.com/developers/rest-api/errors/
...
class Requester:
    ...
    def __init__(self, config: dict = None):
        ...
        self.config = {'api_endpoint': config.get('api_endpoint', 'https://app.notificore.com/rest'),
